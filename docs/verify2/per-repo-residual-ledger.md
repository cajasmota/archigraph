...
| requests | python | 111 | 1.47% (2026-05-19, python-stack-w5; was 1.51%) | python-stack-w5 | clean | at-bar | within striking distance of 1% — push for ship-gate |
| flask-realworld | python | 43 | 7.44% (2026-05-19, python-stack-w5; was 7.49%) | python-stack-w5 | django/DRF/flask/SQLA framework base-class allowlist for EXTENDS structural-refs + Wave-4 pythonBareNames + knownExternalPackages (flask_sqlalchemy/flask_jwt_extended/pymongo/psycopg2/...) + super.X dynamic regex + Wave-5 Mongo/Celery/Boto/SQLA ops. Residual: SQLA `Query.first()` collision-blocked, generic verbs, dotted-receiver class member access | at-bar | dotted-receiver class member binding + #525 EXTENDS kind-disambiguator (in flight) |
| click | python | 138 | 6.434% (2026-05-19, python-stack-w5; was 6.447%) | python-stack-w5 | shared cumulative wins | at-bar | next python wave for ship-gate gap |
| django-realworld | python | 48 | 7.74% (2026-05-19, python-stack-w5; was 7.83%) | python-stack-w5 | django/DRF framework base-class allowlist + Wave-4 pythonBareNames + super.X dynamic regex + bare-kind-prefixed lang="" fallback + Wave-5 Mongo/Celery/Boto/SQLA ops. Residual: DRF ViewSet attribute access (#526), Django URLConf binder (#527), generic verbs (#529) | at-bar | #525 EXTENDS disambiguator (in flight, -3.4pp), #526 DRF ViewSet, #527 URLConf, #529 stragglers — path to ~1.8% |
| pandas | python | 197 | 10.074% (2026-05-19, python-stack-w5; was 10.109%) | python-stack-w5 | numpy/pandas bare-names | structural | further pandas wave needed |
