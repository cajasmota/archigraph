...
// TestDynamicPatterns_CSharp covers the csharpDynamicPatterns catalog.
func TestDynamicPatterns_CSharp(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		// Quartz.NET / Hangfire generic static-factory calls (issue #44).
