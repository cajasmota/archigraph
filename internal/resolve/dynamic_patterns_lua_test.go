...
// TestDynamicPatterns_Lua covers the luaDynamicPatterns catalog.
func TestDynamicPatterns_Lua(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		// Cross-language gate: Lua built-in bare names MUST NOT fire for other languages.
