...
// TestDynamicPatterns_Swift covers the swiftDynamicPatterns catalog.
func TestDynamicPatterns_Swift(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		// Foundation/URLSession bare leaf names.
		...
		// Rails layout must not fire for swift.
