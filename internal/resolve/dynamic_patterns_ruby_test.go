...
// TestDynamicPatterns_Ruby covers the rubyDynamicPatterns catalog.
func TestDynamicPatterns_Ruby(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		// Per-language gate: Rails names MUST NOT fire for non-Ruby languages.
